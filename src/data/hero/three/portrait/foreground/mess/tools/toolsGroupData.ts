...
import { default as toolsGroupConstants } from '@/constants/hero/three/portrait/foreground/mess//tools/toolsGroupConstants.json'

export const getToolsGroupDefaultValues: TElementDefaultValues = {
  ...getDefaultValues(toolsGroupConstants),
}

export function getToolsGroupComponentAnimationsData(): TElementAnimationData {
  return {
