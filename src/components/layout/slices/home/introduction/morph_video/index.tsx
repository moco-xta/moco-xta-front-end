...
const MorphVideo = ({ introductionSectionRef }: TMorphVideo) => {
  ...
  useEffect(() => {
    ...
    const morphAnimation = anime({
      ...
      d: [
        { value: 'M 2.8958327,0.24999949 H 82.27083 c 1.465792,0 2.645834,1.18004161 2.645834,2.64583321 V 45.229166 c 0,1.465792 -1.180042,2.645833 -2.645834,2.645833 H 2.8958327 c -1.4657916,0 -2.64583321,-1.180041 -2.64583321,-2.645833 V 2.8958327 c 0,-1.4657916 1.18004161,-2.64583321 2.64583321,-2.64583321 z' },
