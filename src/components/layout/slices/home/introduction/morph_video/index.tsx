  ...
  useEffect(() => {
    ...
    const morphAnimation = anime({
      ...
      d: [
        ...
        {
          value:
            'M 32.400619,54.148975 H 185.52682 c 6.63902,0 11.98379,5.344771 11.98379,11.983791 v 81.667304 c 0,6.63902 -5.34477,11.98379 -11.98379,11.98379 H 32.400619 c -6.63902,0 -11.983791,-5.34477 -11.983791,-11.98379 V 66.132766 c 0,-6.63902 5.344771,-11.983791 11.983791,-11.983791 z',
        }, // Complex shape
      ],
      easing: 'linear',
