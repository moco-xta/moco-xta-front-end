...
const LogoRedux = forwardRef<ForwardRefGltfGroupInterface, JSX.IntrinsicElements['group']>(function LogoRedux(
  { position, rotation, scale },
  ref,
) {
  const { scene, nodes, materials } = useGLTF(GltfConstants.LOGO_REDUX) as GLTFResult
