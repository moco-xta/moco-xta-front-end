...
const LogoIonic = forwardRef<ForwardRefGltfGroupInterface, JSX.IntrinsicElements['group']>(function LogoIonic(
  { position, rotation, scale },
  ref,
) {
  const { scene, nodes, materials } = useGLTF(GltfConstants.LOGO_IONIC) as GLTFResult
