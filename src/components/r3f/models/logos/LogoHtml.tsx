...
const LogoHtml = forwardRef<ForwardRefGltfGroupInterface, JSX.IntrinsicElements['group']>(function LogoHtml(
  { position, rotation, scale },
  ref,
) {
  const { scene, nodes, materials } = useGLTF(GltfConstants.LOGO_HTML) as GLTFResult
