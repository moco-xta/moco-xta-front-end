...
export function GraphicsPack(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <>
      <group position={[-1.221, 0.942, 0]} rotation={[-0.212, 0.23, 0.41]}>
        <mesh geometry={nodes.GraphicsSkills_1.geometry} material={materials['icon_illustrator_#320000']} />
        <mesh geometry={nodes.GraphicsSkills_2.geometry} material={materials['icon_illustrator_#f89a01']} />
        <mesh geometry={nodes.GraphicsSkills_3.geometry} material={materials['icon_photoshop_#051e37']} />
        <mesh geometry={nodes.GraphicsSkills_4.geometry} material={materials['icon_photoshop_#39a9ff']} />
        <mesh geometry={nodes.GraphicsSkills_5.geometry} material={materials['icon_blender_#265787']} />
        <mesh geometry={nodes.GraphicsSkills_6.geometry} material={materials['icon_blender_#ea7600']} />
        <mesh geometry={nodes.GraphicsSkills_7.geometry} material={materials['icon_blender_#ffffff']} />
      </group>
      <mesh geometry={nodes.GraphicsPack.geometry} material={materials.Material} scale={[1, 1, 0.8]} />
    </>
  )
}
