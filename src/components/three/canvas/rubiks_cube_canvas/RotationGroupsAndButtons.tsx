...
import { RotationGroupsAndButtonsInterface } from '@/interfaces/rubiksCubeInterfaces'
...
export default function RotationGroupAndButtons({
  rubiksCubeRef,
}: RotationGroupsAndButtonsInterface) {
  ...
  return (
    <>
      {rubiksCubeConstants.RUBIKS_CUBE.BUTTONS.TEST.map((buttonCategory, buttonCategoryIndex) => {
