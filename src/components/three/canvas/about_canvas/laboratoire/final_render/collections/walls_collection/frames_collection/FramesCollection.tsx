...
import { AmorLlamaAmor } from '@/components/three/models/about/laboratoire/final_render/walls_collection/frames_collection/AmorLlamaAmor'
import { Brain } from '@/components/three/models/about/laboratoire/final_render/walls_collection/frames_collection/Brain'
import { CelestialMap } from '@/components/three/models/about/laboratoire/final_render/walls_collection/frames_collection/CelestialMap'
import { Couronnes } from '@/components/three/models/about/laboratoire/final_render/walls_collection/frames_collection/Couronnes'
import { FrameGlasses } from '@/components/three/models/about/laboratoire/final_render/walls_collection/frames_collection/FrameGlasses'
import { Monarch } from '@/components/three/models/about/laboratoire/final_render/walls_collection/frames_collection/Monarch'
import { NicotianaRustica } from '@/components/three/models/about/laboratoire/final_render/walls_collection/frames_collection/NicotianaRustica'
import { Trinity } from '@/components/three/models/about/laboratoire/final_render/walls_collection/frames_collection/Trinity'
