...
export default function ProfilePicture() {
  ...
  const texturesUrls = [
    texturesConstants.HERO.PORTRAIT.LOGO_ATHLETICO_NACIONAL,
    texturesConstants.HERO.PORTRAIT.PROFILE_PICTURE,
  ...
  const handleMouseMove = useCallback(
    (e: MouseEvent) => {
      ...
      const intersects = raycasterRef.current.intersectObjects([test])
