...
const LogoSass = forwardRef<THREE.Group, TLogo>(({ roughness, metalness, ...rest }, ref) => {
  const { nodes, materials } = useGLTF(glbConstants.LOGOS.LOGO_SASS) as GLTFResult
...
useGLTF.preload(glbConstants.LOGOS.LOGO_SASS)
