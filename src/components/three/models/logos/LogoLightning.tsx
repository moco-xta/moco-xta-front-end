...
const LogoLightning = forwardRef<THREE.Group, TLogo>(({ roughness, metalness, ...rest }, ref) => {
  const { nodes, materials } = useGLTF(glbConstants.LOGOS.LOGO_LIGHTNING) as GLTFResult
...
useGLTF.preload(glbConstants.LOGOS.LOGO_LIGHTNING)
