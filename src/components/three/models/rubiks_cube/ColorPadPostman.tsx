...
const ColorPadPostman = forwardRef<
  ...
  >,
  MeshProps
>(function ColorPadPostman({ name, position, rotation, onPointerOver, onPointerLeave }, ref) {
  const { nodes } = useGLTF(gltfConstants.RUBIKS_CUBE.COLOR_PAD_POSTMAN) as GLTFResult
