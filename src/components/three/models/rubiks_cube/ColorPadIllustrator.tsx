...
const ColorPadIllustrator = forwardRef<
  ...
  >,
  MeshProps
>(function ColorPadIllustrator({ name, position, rotation, onPointerOver, onPointerLeave }, ref) {
  const { nodes } = useGLTF(gltfConstants.RUBIKS_CUBE.COLOR_PAD_ILLUSTRATOR) as GLTFResult
