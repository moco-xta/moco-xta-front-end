...
const ColorPadGsap = forwardRef<
  ...
  >,
  MeshProps
>(function ColorPadGsap({ name, position, rotation, onPointerOver, onPointerLeave }, ref) {
  const { nodes } = useGLTF(gltfConstants.RUBIKS_CUBE.COLOR_PAD_GSAP) as GLTFResult
