...
export default function LightsCollection() {
  ...
  const ref = useRef<Ref<THREE.SpotLight>[]>(
    laboratoireFinalRenderConstants.LIGHTS_COLLECTION.CEILING_SPOT_LIGHTS.ORIENTATION.map(
  ...
  const spotLigthsPosition = useControls('SPOT LIGHTS: Position', {
    'position-x': {
      value:
        laboratoireFinalRenderConstants.LIGHTS_COLLECTION.CEILING_SPOT_LIGHTS
          .POSITION.X,
      min: 0,
      max: 40,
      step: 0.1,
          ...
          <spotLight
            ...
            position={
              !debug.lights
                ? [
                    orientation[0] *
                      laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                        .CEILING_SPOT_LIGHTS.POSITION.X,
                    orientation[1] *
                      laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                        .CEILING_SPOT_LIGHTS.POSITION.Y,
                    orientation[2] *
                      laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                        .CEILING_SPOT_LIGHTS.POSITION.Z,
                  ]
                : [
            ...
            target-position={
              !debug.lights
                ? new THREE.Vector3(
                    orientation[0] *
                      laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                        .CEILING_SPOT_LIGHTS.TARGET_POSITION.X,
                    orientation[1] *
                      laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                        .CEILING_SPOT_LIGHTS.TARGET_POSITION.Y,
                    orientation[2] *
                      laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                        .CEILING_SPOT_LIGHTS.TARGET_POSITION.Z,
                  )
                : new THREE.Vector3(
            ...
            shadow-mapSize={[
              laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                .CEILING_SPOT_LIGHTS.SHADOW_MAP_SIZE *
                laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                  .CEILING_SPOT_LIGHTS.K,
              laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                .CEILING_SPOT_LIGHTS.SHADOW_MAP_SIZE *
                laboratoireFinalRenderConstants.LIGHTS_COLLECTION
                  .CEILING_SPOT_LIGHTS.K,
