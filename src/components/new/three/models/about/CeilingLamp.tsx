...
export function CeilingLamp({ position }: JSX.IntrinsicElements['mesh']) {
  const { nodes } = useGLTF(gltfConstants.ABOUT.CEILING_LAMP) as GLTFResult
...
useGLTF.preload(gltfConstants.ABOUT.CEILING_LAMP)
