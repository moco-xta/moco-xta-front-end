;(function (V) {
  ...
  mix_d(
    ...
    function (a, c, d, e) {
      ...
      function f(a, b) {
        return k['default'].promise(
          new Promise(function (d, e) {
            var p = c.__assign(c.__assign({}, b), {
              abort: function () {
              ...
              error: function (a, b) {
                ...
                200 === c || 202 === c || 204 === c || 304 === c
                  ? d(l(a, a.http.responseText))
                  : ((a = new r(
                      'Ajax request failed',
                      a.http.status,
                      b,
                      a.http.status ? K : 'readyState: ' + a.http.readyState + '.',
                    )),
                    e(a))
              },
  ...
  mix_d(
    ...
    function (a, c, d, e, b, h, l, u, v) {
      ...
      function A(a, c, d) {
                          ...
                          return (
                            ...
                            [
                              ...
                              n['default'].unlockForEvent(d, function () {
                                return e.__awaiter(m, void 0, void 0, function () {
                                  var m
                                  return e.__generator(this, function (D) {
                                    switch (D.label) {
                                      case 0:
                                      ...
                                      case 1:
                                        return D.sent(), [3, 3]
                                      case 2:
                                        return (m = D.sent()), w['default'].log(m), [3, 3]
                                      case 3:
                                        return [2]
                                    }
                                  })
        ...
        return L(p).reduce(function (a, b) {
      ...
      function G(a) {
        var b = a.target,
          c = []
        if (a.eventPhase === Event.CAPTURING_PHASE) M(b) && t(b) && c.push(b)
        else for (; M(b); ) t(b) && c.push(b), (b = b.parentElement)
        return c
      }
      function y(a) {
        return (a = t(a))
              ...
              F[b]
                ...
                : ((O[a] = O[a] || []),
                  ...
                  0 > C.listeners.indexOf(b) &&
                    (document.addEventListener(b, p, !!J[b]), C.listeners.push(b)))
            })
          },
          attach: function (a, b) {
      ...
      var w = k(v),
        ...
        M = function (a) {
          return !!a && a.nodeType === Node.ELEMENT_NODE && I['default'].isAccessibleElement(a)
        },
        O = {}
      a['default'] = { setup: B }
      a.initialize = function (a, b, c) {
        C.cards.push({ operations: O, cardHandler: A, ScopedDom: I['default'] })
      }
      a.setup = B
      Object.defineProperty(a, '__esModule', { value: !0 })
    },
  ...
  mix_d('@amzn/mix.client-runtime', ['exports', 'tslib'], function (a, c) {
      ...
      return c.__awaiter(this, void 0, void 0, function () {
              ...
              switch (c.label) {
                ...
                case 1:
                  return (
                    (d = c.sent()),
                    (p = d.capabilities),
                    (t = k = d.cardModuleFactory),
                    [4, Promise.all((p || []).map(e))]
                  )
                case 2:
                  return (l = t.apply(void 0, [c.sent()])), h.push(l), [2, l]
              }
            })
          })
        }
        ...
        return c.__generator(this, function (b) {
          switch (b.label) {
            ...
            case 1:
              return (k = b.sent()), [2, { requestedOrder: k, initializationOrder: h }]
          }
        })
      })
    }
    function l(a, b) {
      ...
      else a.log('Could not register card: Candidate root not found', 'WARN', 'MIX')
    }
    function u(a) {
    ...
    var v = {},
      ...
      r = function (a, b, d, e, k) {
        ...
        return c.__awaiter(void 0, void 0, void 0, function () {
          var p, l, t, q, v, f, r, F, H, L, M
          return c.__generator(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, h(null !== (L = b.capabilities) && void 0 !== L ? L : [], e)]
              case 1:
                return (
                  (p = n.sent()),
                  (l = p.initializationOrder),
                  (t = p.requestedOrder),
                  (v = []),
              ...
              case 2:
                return (
                  (f = n.sent()),
                  (r = c.__read(f.requestedOrder, 1)),
                  (F = r[0]),
                  (H = f.initializationOrder),
                  (q = F),
                  (v = H),
                  [3, 4]
                )
              case 3:
                ;(q = null !== (M = k[a]) && void 0 !== M ? M : (k[a] = b.cardModuleFactory(t, d))),
                  (n.label = 4)
              case 4:
                return [2, { resolvedMod: q, capabilitiesToInitialize: c.__spread(v, l) }]
            }
          })
        })
      }
                          ...
                          return c.__generator(this, function (g) {
                            switch (g.label) {
                              case 0:
                                ...
                                g.label = 1
                              case 1:
                                return g.trys.push([1, 3, , 4]), [4, r(h, d, k, e, p)]
                              case 2:
                                return (
                                  (F = g.sent()),
                                  (l = F.resolvedMod),
                      ...
                      d
                        ? ((C = u(d)),
                          ...
                          (d = n.card(C)) && d.then
                            ...
                            : b())
                        : (f.mixCardInitTimeouts && clearTimeout(f.mixCardInitTimeouts[a]), b())
                    })
                  }),
                ]
              )
  ...
  mix_d(
    ...
    function (a, c, d, e, b, h, l, u) {
      ...
      function k(a) {
        var b = function (d) {
          var g = b.trackingApplicable,
            ...
            z = O + a,
            e = { 'page-type': 'page-type' in H ? H['page-type'] : 'undefined' }
          N !== K &&
            (D && (z += -1 !== z.indexOf('?') ? '\x26track\x3dtrue' : '/track'),
            (e = c.__assign(c.__assign({}, e), (g ? L(N, m || {}) : N) || {})))
          P && (e = c.__assign(c.__assign({}, e), { stamp: P }))
          m = []
          for (var F in e)
            e.hasOwnProperty(F) &&
              ((D = e[F]), m.push(encodeURIComponent(F) + '\x3d' + encodeURIComponent(D)))
          z += (-1 !== z.indexOf('?') ? '\x26' : '?') + m.join('\x26')
          e = {}
          g || (e['x-amz-amabot-click-attributes'] = 'disable')
          return n(z, a, d, E, e)
        }
      ...
      var p = v(d),
        ...
        n = function (a, b, d, g, m) {
          a = A['default'].post(
            a,
            {
              accepts: 'text/html, application/json',
              contentType: 'application/json',
              additionalHeaders: c.__assign(c.__assign({}, m), { 'x-amz-acp-params': g }),
            },
            d,
          )
          a.then(
            ...
            function (a) {
              if (I(a)) {
                var g = a.statusCode
                'Request Timeout' === a.statusText ? q(b, 'timeout') : q(b, 'error', g)
              } else 'Ajax request aborted' === a && q(b, 'abort')
            },
          )
          return G['default'].promise(
            a.then(function (a) {
              var b = a.contentType
              a = a.responseBody
              if ('NO-CONTENT-TYPE-FOUND' !== b || a) {
                ...
                if ('text/html' === b)
                  try {
                    ...
                    throw Error('Error encountered when parsing html response: ' + W)
                  }
      ...
      var H = c.__assign({}, h),
        L = function (a, b) {
          ...
          d = d || ''
          var D = m
          g ? (D = g) : d && ((g = m.match(C) || d.match(J)), (D = [m, d].join(g ? '' : '_')))
          m = (m = D) ? { ref_: m } : {}
          return c.__assign(c.__assign(c.__assign(c.__assign(c.__assign({}, H), a), b), m), F)
        },
        M = function () {
      ...
      a.initialize = function (a, b, c) {
        if (
          ...
          try {
            ...
            g.innerHTML = b
            E = 0 === g.childNodes.length ? '' : g.childNodes[0].nodeValue || ''
          } catch (m) {
            throw Error(
          ...
          a.hasAttribute('data-acp-stamp') &&
            ((P = a.getAttribute('data-acp-stamp') || ''), a.removeAttribute('data-acp-stamp'))
        } else
          throw Error(
            'Remote Operation capability requires card root node to exist and have attribute: data-acp-path \x26 data-acp-params',
          )
        a: {
          if (p['default'].cardRoot.hasAttribute('data-acp-tracking'))
            try {
              N = JSON.parse(p['default'].cardRoot.getAttribute('data-acp-tracking'))
              break a
            } catch (m) {
              f.P.logError(m, m instanceof SyntaxError ? '' + M : null, 'ERROR')
            }
          N = K
        }
        c._operationNames && t(S, c._operationNames)
      }
      a.isAjaxError = I
      a.setup = r
      Object.defineProperty(a, '__esModule', { value: !0 })
  ...
  mix_d('@c/scoped-dom', ['exports', 'tslib', '@c/dom'], function (a, c, d) {
    function e(a, b) {
      return a instanceof HTMLElement || a instanceof Node
        ? (b && b.contains(a)) ||
            p['default'].scopes.some(function (b) {
              return b.contains(a)
            }) ||
        ...
        a instanceof HTMLElement || a instanceof Node
          ...
          : a instanceof HTMLCollection || a instanceof NodeList
            ...
            : a instanceof Event
              ? v()
              : void 0
      e(a, b) ? c && (a[C] || (a[C] = new Proxy(a, c)), (a = a[C])) : (a = null)
      return a
    }
    function h(a) {
      return function () {
        ...
        b = b.map(function (a) {
          return 'function' === typeof a ? l(a) : a !== K && a.__unscope__ ? d.unscope(a) : a
        })
    ...
    function k() {
      return {
        get: function (a, c) {
          ...
          'closest' === c && (d = G)
          return 'function' === typeof d ? t(d, a, c) : b(d)
        },
        set: function (a, c, d) {
      ...
      if (!f) {
        if ('addEventListener' === e) {
          ...
          a = function (a, b, d) {
            b =
              'handleEvent' in b
                ? c.__assign(c.__assign({}, b), { handleEvent: l(b.handleEvent) })
                : b
            return p.call(this, a, b, d)
          }
        }
        f = h(a)
        q[e] = f
      ...
      return {
        get: function (a, c) {
          ...
          return e && !1 === e.configurable && !1 === e.writable
            ? d
            : 'number' === typeof c ||
                ('string' === typeof c && Number.isInteger(Number.parseInt(c, 10)))
              ? b(d)
              : '__unscope__' === c
                ? u(a)
                : d
    ...
    var p = d && 'object' === typeof d && 'default' in d ? d : { default: d }
    ...
    var A =
      ...
      x = function (a) {
        return e.apply(void 0, c.__spread([a.target], p['default'].scopes))
      },
      I = function (a) {
        return e.apply(void 0, c.__spread([a], p['default'].scopes))
      },
      n = function (a) {
        return a()
      },
      ...
      w = {
        get cardRoot() {
          return b(p['default'].cardRoot, p['default'].cardRoot)
        },
        scopeElement: B,
        isAccessibleEvent: x,
  ...
  mix_d('@c/siege', ['exports'], function (a) {
    var c = function (a, b) {
        return a.factoryClone({ trackingParams: { sif_profile: b }, trackingApplicable: !0 })
      },
      d = { applySifProfile: c }
    a.applySifProfile = c
    a['default'] = d
  ...
  mix_d(
    ...
    function (a, c, d, e, b) {
      ...
      var l = f(d),
        ...
        t = function () {
          if (!l['default'].cardRoot.hasAttribute('data-acp-tracking')) {
      ...
      d = function (a, b, d) {
        ...
        return t() ? r(e[a], c.__assign(c.__assign({}, b), { refSuffix: d }), !0) : e[a]
      }
      e = function (a, b, d) {
        void 0 === b && (b = {})
        return t() ? r(a, c.__assign(c.__assign({}, b), { refSuffix: d })) : a
      }
  ...
  ;(function () {
    ...
    a.amd = !0
    var c, d, e, b, f, l, u, v, k, t, r, p, A, G, y, B, x, I, n, q, w, C, J, F, H, L, M, O, E, N, P
    ;(function (b) {
      function c(a, b) {
        a !== d &&
      ...
      b = function (a, b, c, d) {
        var g = arguments.length,
          m = 3 > g ? b : null === d ? (d = Object.getOwnPropertyDescriptor(b, c)) : d,
          e
        if ('object' === typeof Reflect && 'function' === typeof Reflect.decorate)
          m = Reflect.decorate(a, b, c, d)
        else
          for (var D = a.length - 1; 0 <= D; D--)
            if ((e = a[D])) m = (3 > g ? e(m) : 3 < g ? e(b, c, m) : e(b, c)) || m
        return 3 < g && m && Object.defineProperty(b, c, m), m
      }
      f = function (a, b) {
        return function (c, d) {
          b(c, d, a)
      ...
      l = function (a, b, c, d, e, z) {
        ...
        for (var f, q = !1, h = c.length - 1; 0 <= h; h--) {
          ...
          var R = (0, c[h])('accessor' === m ? { get: b.get, set: b.set } : b[D], f)
          if ('accessor' === m) {
            if (void 0 !== R) {
              if (null === R || 'object' !== typeof R) throw new TypeError('Object expected')
              if ((f = g(R.get))) b.get = f
              if ((f = g(R.set))) b.set = f
              ;(f = g(R.init)) && e.unshift(f)
            }
          } else if ((f = g(R))) 'field' === m ? e.unshift(f) : (b[D] = f)
        }
      ...
      k = function (a, b, c) {
        'symbol' === typeof b && (b = b.description ? '['.concat(b.description, ']') : '')
      ...
      r = function (a, b, c, d) {
        ...
        return new (c || (c = Promise))(function (c, e) {
          ...
          function f(a) {
            a.done ? c(a.value) : g(a.value).then(m, D)
          }
                ...
                m &&
                  (f =
                    c[0] & 2
                      ? m['return']
                      : c[0]
                        ? m['throw'] || ((f = m['return']) && f.call(m), 0)
                        : m.next) &&
                  !(f = f.call(m, c[1])).done)
              )
                return f
              if (((m = 0), f)) c = [c[0] & 2, f.value]
              switch (c[0]) {
                case 0:
                case 1:
                  f = c
                ...
                default:
                  ...
                  if (3 === c[0] && (!f || (c[1] > f[0] && c[1] < f[3]))) g.label = c[1]
                  else if (6 === c[0] && g.label < f[1]) (g.label = f[1]), (f = c)
      ...
      A = function (a, b) {
        for (var c in a) 'default' === c || Object.prototype.hasOwnProperty.call(b, c) || E(b, a, c)
      }
      E = Object.create
        ? function (a, b, c, d) {
            d === K && (d = c)
      ...
      y = function (a, b) {
        ...
        var d,
          g = []
        try {
          for (; (void 0 === b || 0 < b--) && !(d = a.next()).done; ) g.push(d.value)
        } catch (Q) {
          var e = { error: Q }
        } finally {
          try {
      ...
      B = function () {
        for (var a = [], b = 0; b < arguments.length; b++) a = a.concat(y(arguments[b]))
        return a
      }
      x = function () {
        ...
        var d = 0
        for (b = 0; b < c; b++)
          for (var e = arguments[b], f = 0, z = e.length; f < z; f++, d++) a[d] = e[f]
        return a
      }
      I = function (a, b, c) {
        if (c || 2 === arguments.length)
          for (var d = 0, g = b.length, e; d < g; d++)
            (!e && d in b) || (e || (e = Array.prototype.slice.call(b, 0, d)), (e[d] = b[d]))
      ...
      q = function (a, b, c) {
        ...
        function g(a, b) {
          try {
            var c = z[a](b)
            c.value instanceof n ? Promise.resolve(c.value.v).then(e, f) : m(h[0][2], c)
          } catch (aa) {
            m(h[0][3], aa)
          }
        }
      ...
      w = function (a) {
        function b(b, g) {
          c[b] = a[b]
            ? function (c) {
                return (d = !d) ? { value: n(a[b](c)), done: !1 } : g ? g(c) : c
              }
            : g
        }
        var c, d
      ...
      C = function (a) {
        ...
        return d
          ? d.call(a)
          : ((a = 'function' === typeof G ? G(a) : a[Symbol.iterator]()),
            (g = {}),
            b('next'),
            b('throw'),
            b('return'),
      ...
      N = function (a, b, c) {
        if (null !== b && void 0 !== b) {
          ...
          if ('function' !== typeof d) throw new TypeError('Object not disposable.')
      ...
      var Z =
        'function' === typeof SuppressedError
          ...
          : function (a, b, c) {
              c = Error(c)
              return (c.name = 'SuppressedError'), (c.error = a), (c.suppressed = b), c
            }
      P = function (a) {
        function b(b) {
          a.error = a.hasError ? new Z(b, a.error, 'An error was suppressed during disposal.') : b
          a.hasError = !0
        }
        function c() {
          for (; a.stack.length; ) {
      ...
      a('__spreadArray', I)
      a('__await', n)
      a('__asyncGenerator', q)
      a('__asyncDelegator', w)
      a('__asyncValues', C)
      a('__makeTemplateObject', J)
      a('__importStar', F)
      a('__importDefault', H)
      a('__classPrivateFieldGet', L)
      a('__classPrivateFieldSet', M)
  ...
  mix_d(
    ...
    function (a, c, d, e, b, h, l, u, v, k, t) {
      function r(a) {
        return a && 'object' === typeof a && 'default' in a ? a : { default: a }
      }
      function p() {}
      function A(a, d, e) {
        var f = this
        void 0 === e && (e = {})
        var q = B['default'].cardRoot.querySelector(d)
        d =
        ...
        if (!q)
          throw Error(
            d + ' A root element is required. Cannot find a matched element by the given selector',
          )
        if (
          'function' === typeof getComputedStyle &&
          'none' !== getComputedStyle(b.unscope(q)).display
        )
          throw Error(
            d +
        ...
        x['default'].one('a:sheet:beforeShow:' + h, function () {
          t.instrumentCel(b.unscope(q), 'bottom-sheet-' + a)
        })
        var l = B['default'].scopeElement(b.unscope(q)).root,
          w = k._height
        return C(
          {
            getHeight: function () {
            ...
            changeHeight: function (a) {
              return !0 === k._fullScreen
                ? (G['default'].log('Cannot call changeHeight on full screen sheet', 'FATAL'),
                  Promise.resolve(!1))
            ...
            show: function () {
              return y['default'].isLockedFor(['click'])
                ...
                : new Promise(function (b) {
                    ...
                    n['default'].showSheet(k)
                      ? t.count('bottomSheet:' + a + ':show', 1)
                      : (x['default'].off('a:sheet:afterShow:' + h, c),
                        t.count('bottomSheet:' + a + ':show', 0),
                        b(!1))
                  })
            },
            hide: function () {
              return y['default'].isLockedFor(['click'])
                ...
                : new Promise(function (b) {
                    ...
                    n['default'].hideSheet(k)
                      ? t.count('bottomSheet:' + a + ':hide', 1)
                      : (x['default'].off('a:sheet:afterHide:' + h, c),
                        t.count('bottomSheet:' + a + ':hide', 0),
                        b(!1))
                  })
            },
            render: function (a) {
        ...
        w = function (a, b, c) {
          return a.__wrapHandler
            ...
            : (a.__wrapHandler = function (d) {
                d = q['default'].current(a)(c ? c(d, b) : d)
                d instanceof Promise && q['default'].promise(d)
              })
        },
        C = function (a, b, d) {
  ...
  mix_d(
    ...
    function (a, c, d, e) {
      ...
      var u = b(c),
        v = b(d)
      a['default'] = { getCard: f, getCardDeck: l }
      a.getCard = f
      a.getCardDeck = l
      a.initialize = function (a, b, c) {}
      Object.defineProperty(a, '__esModule', { value: !0 })
        ...
        return function (h, q) {
          return c.__awaiter(e, void 0, void 0, function () {
            ...
            return c.__generator(this, function (c) {
              switch (c.label) {
                case 0:
                  return [4, a({ indexes: h, ids: q })]
                case 1:
                  e = c.sent()
                  'string' === typeof e &&
                    (e = new DOMParser().parseFromString(e, 'text/html').body.children[0])
                  ...
                  if (
                    ...
                    for (k = w.length - 1; 0 <= k; k--) l.id_list.splice(w[k], 1)
                    b.setAttr('ajax', l)
                    f &&
                      p['default'].requestAnimationFrame(function () {
                        f(b)
                      })
                  }
                  return [2, n]
  ...
  mix_d(
    ...
    function (a, c, d, e, b, h, l, u, v, k, t) {
      ...
      function A(a) {
        if ('' === f.mixActiveModal)
          (f.mixActiveModal = a), w['default'].one('a:popover:invisible:' + a, p)
        else if (f.mixActiveModal !== a) throw Error(E.modalInUsed(f.mixActiveModal))
      }
      function G() {}
      function y(a) {
        ...
        return O(
          {
            ...
            show: function () {
              return c.__awaiter(g, void 0, void 0, function () {
                return c.__generator(this, function (b) {
                  return L['default'].isLockedFor(U)
                    ? (J['default'].log(
                        E.failToCallFor('show', y(a)) + '  ' + E.missingUserInteraction(U),
                        'FATAL',
                      ),
                      [2, Promise.resolve(!1)])
                    : [
                        ...
                        new Promise(function (b) {
                          ...
                          try {
                            ...
                            J['default'].log(
                              E.failToCallFor('show', y(a)) + ' ' + Q.message,
                              'FATAL',
                            ),
                              Q.message !== E.modalInUsed(f.mixActiveModal) &&
                                f.mixActiveModal === a &&
                                (w['default'].off('a:popover:invisible:' + a, p), p()),
            ...
            hide: function () {
              return c.__awaiter(g, void 0, void 0, function () {
                return c.__generator(this, function (b) {
                  return L['default'].isLockedFor(U)
                    ? (J['default'].log(
                        E.failToCallFor('hide', y(a)) + '  ' + E.missingUserInteraction(U),
                        'FATAL',
                      ),
                      [2, Promise.resolve(!1)])
                    : [
                        ...
                        new Promise(function (b) {
                          ...
                          try {
                            ...
                            J['default'].log(
                              E.failToCallFor('hide', y(a)) + ' ' + Q.message,
                              'FATAL',
                            ),
                  ...
                  e = function () {
                    return new Promise(function (c, e) {
                      try {
                        ...
                        J['default'].log(
                          E.failToCallFor('render', y(a)) + ' ' + Y.message,
                          'FATAL',
                        ),
                          e(Y)
                      }
      ...
      function n(a, d, e) {
        ...
        if (F['default'].isSupported('mobile')) throw Error(f + ' ' + E.unsupportedDevice('mobile'))
        if (!a) throw Error(f + ' ' + E.invalidName(a))
        if (q['default'].get(a + '-' + N)) throw Error(f + ' ' + E.usedName(a))
        if (!d) throw Error(f + ' ' + E.unavailableRoot())
        if (y(d.getAttribute('data-a-modal-id')))
          throw Error(f + ' ' + E.usedRootOf(y(d.getAttribute('data-a-modal-id'))))
          ...
          c.__assign(
            {
              ...
              hideHeader: e.header === K,
              header: e.header,
              closeButton: e.closeButton === K ? !0 : e.closeButton,
              closeButtonLabel: e.a11yCloseButtonMessage,
              padding: 'none',
              legacyNavigable: !1,
            },
        ...
        e = q['default'].create(g, e)
        f = I(f, e, d)
        try {
          var h = e.attrs('name'),
            l = b.unscope(d),
            k = document.createElement('span')
          C['default'].cardRoot.appendChild(k)
          k.id = 'a-popover-' + h
          ...
          throw Error(E.failToCallFor('create', a) + ' ' + Q.message)
        }
        return f
      }
      var q = r(d),
        ...
        E = {
          failToCallFor: function (a, b) {
            return (
              "@amzn/mix.client-cap.aui-modal: Failed to call '" + a + "' on modal '" + b + "'."
            )
          },
          usedName: function (a) {
            return (
  ...
  mix_d('@c/aui-truncate', ['exports', '@c/dom', '@p/a-truncate'], function (a, c, d) {
    ...
    a['default'] = {
      ...
      switchToAutoTruncate: l,
      updateAll: u,
    }
    a.initialize = function (a, b, c) {}
    a.manualTruncate = b
    a.refreshAutoTruncate = f
    a.switchToAutoTruncate = l
    a.updateAll = u
    Object.defineProperty(a, '__esModule', { value: !0 })
  })
